...
is
   ...
   type Kind_Type is
   (
      Kind_Invalid,      -- Invalid node
      Kind_Element_Open, -- Opening element
   ...
   --  Documents can be joined to a valid result document
   --
   --  @param Left   Document
   --  @param Right  Document
